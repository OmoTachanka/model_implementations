...
gen = Generator(z_dim, channels_img, feats_gen, num_classes, img_size, embed_size).to(device)
disc = Discriminator(channels_img, feats_disc, num_classes, img_size).to(device)
